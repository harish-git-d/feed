-- SCEF GAI Feed: pse-exposure ATTRIBUTE — Full field list A1-A33
...
SELECT
    ...
    'PSE'                                             AS ATTRIBUTE_NAME,        -- A4
    TRIM('NA')                                                 AS ATTRIBUTE_DESCRIPTION, -- A5
    TO_CHAR(r.CURRENT_OUTSTANDING_PSE)                                                 AS OLD_VALUE,             -- A6
    TO_CHAR(r.CORRECT_OUTSTANDING_PSE)                                                 AS NEW_VALUE,             -- A7
