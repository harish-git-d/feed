-- SCEF GAI Feed: pse-month-end EVENT — Full field list E1-E24
...
SELECT DISTINCT
    ...
    'Risk User Adjustment - Month End PSE Exposure - Facility'                                                AS REASON_CODE,           -- E4
